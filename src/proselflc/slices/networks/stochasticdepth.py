    ...
    def forward(self, x):
        ...
        if self.training:
            if self.survival():
                ...
                #    if self.train then
                #        if self.gate then
                #        -- only compute convolutional output when gate is open
...
def stochastic_depth_resnet18(params: dict = {"num_classes": 100}):
    """return a ResNet 18 object"""
    return StochasticDepthResNet(
        StochasticDepthBasicBlock, [2, 2, 2, 2], class_num=params["num_classes"]
    )


def stochastic_depth_resnet34(params: dict = {"num_classes": 100}):
    """return a ResNet 34 object"""
    return StochasticDepthResNet(
        StochasticDepthBasicBlock, [3, 4, 6, 3], class_num=params["num_classes"]
    )


def stochastic_depth_resnet50(params: dict = {"num_classes": 100}):

    """return a ResNet 50 object"""
    return StochasticDepthResNet(
        StochasticDepthBottleNeck, [3, 4, 6, 3], class_num=params["num_classes"]
    )


def stochastic_depth_resnet101(params: dict = {"num_classes": 100}):
    """return a ResNet 101 object"""
    return StochasticDepthResNet(
        StochasticDepthBottleNeck, [3, 4, 23, 3], class_num=params["num_classes"]
    )


def stochastic_depth_resnet152(params: dict = {"num_classes": 100}):
    """return a ResNet 152 object"""
    return StochasticDepthResNet(
        StochasticDepthBottleNeck, [3, 8, 36, 3], class_num=params["num_classes"]
    )
