...
from proselflc.slices.datain.dataloaders.clothing1mdataloader import Clothing1MLoader
from proselflc.slices.datain.dataloaders.deeplocdataloaders import (
    DeepLocTrainLoaderTestset,
)
from proselflc.slices.datain.dataloaders.food101n import Food101NLoader
...
class DataLoaderPool:
    ...
    validated_dataloaders = {
        ...
        "clothing1m_withbs": Clothing1MLoader,
        "deeploc_prottrans": DeepLocTrainLoaderTestset,
        "food101n": Food101NLoader,
    }

    @classmethod
    def get_dataloader(cls, params={}):
        """
        Returns:
