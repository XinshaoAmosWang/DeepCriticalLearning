...
class TestTrainer(unittest.TestCase):
    ...
    def test_trainer(self):
        total = 12  # total number of experiments to run
        single_split = total // 1  # depends on how many gpus you have
        ...
        for (
            ...
            # < 1, entropy decreases
            [
                ("labelsmoothing", None, 0),
                #
                ("labelsmoothing", None, 0.125),
                #
                ("confidencepenalty", 0.4, 0.25),
                #
                ("labelcorrection", 0.2, 0.25),
            ],
        ):
            k = k + 1
            print(k)
